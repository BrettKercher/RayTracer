...
private:
	...
	static void cb_numThreads(Fl_Widget* o, void* v);
	static void check_progress(int total);

	static void cb_render(Fl_Widget* o, void* v);
	static void thread_render(int startingPixel, int pixelsPerThread);
	...
	static void cb_antialiasPixels(Fl_Widget* o, void* v);
	static void cb_antialiasThresh(Fl_Widget* o, void* v);
	static void cb_treeCheckButton(Fl_Widget* o, void* v);
	static void cb_treeDepth(Fl_Widget* o, void* v);
	static void cb_treeLeaves(Fl_Widget* o, void* v);
